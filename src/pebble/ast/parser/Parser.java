...
import pebble.ast.*;
import pebble.ast.node.ASTLeaf;
import pebble.ast.node.ASTList;
...
public class Parser {
    ...
    protected static class OrTree extends Element {
            ...
            throws ParseException
        {
            ...
            if (p == null)
                throw new SyntaxException(lexer.peek(0));
            else
    ...
    protected static class Leaf extends Element {
            ...
            throws ParseException
        {
            ...
            if (tokens.length > 0)
                throw new SyntaxException(tokens[0] + " expected.", t);
            else
                throw new SyntaxException(t);
        }
